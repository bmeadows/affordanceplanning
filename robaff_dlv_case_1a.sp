% Affordance planner (version for testing claim 1, ground truth)

% Name:          robaff_dlv_case_1a.sp
% Author:        Ben Meadows
...
% java -jar sparc.jar robaff_dlv_case_1a.sp -solver dlv -A > plans_out.txt
