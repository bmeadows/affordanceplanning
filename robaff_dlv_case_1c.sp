% Affordance planner (version for testing claim 1c, plan generation with one forbidding affordance removed)

% Name:          robaff_dlv_case_1c.sp
% Author:        Ben Meadows
...
% java -jar sparc.jar robaff_dlv_case_1c.sp -solver dlv -A > plans_out.txt
