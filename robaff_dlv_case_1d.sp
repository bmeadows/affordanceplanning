% Affordance planner (version for testing claim 1d, plan generation with all permitting affordances removed)

% Name:          robaff_dlv_case_1d.sp
% Author:        Ben Meadows
...
% java -jar sparc.jar robaff_dlv_case_1d.sp -solver dlv -A > plans_out.txt
