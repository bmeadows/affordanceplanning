% Affordance planner (version for testing claim 1e, plan generation with one permitting affordance removed)

% Name:          robaff_dlv_case_1e.sp
% Author:        Ben Meadows
...
% java -jar sparc.jar robaff_dlv_case_1e.sp -solver dlv -A > plans_out.txt
